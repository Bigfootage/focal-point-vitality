    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 max-w-4xl">
          Conditions We <span className="text-gold-500">Help</span>
        </h2>
        <p className="text-xl text-gray-300 max-w-3xl">
          Comprehensive care for the symptoms that impact your daily life and long-term health.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-black border border-gold-600 flex items-center justify-center shadow-lg">
                <div className="h-4 w-4 rounded-full bg-gold-500 border border-gold-600 p-2" />
              </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-gold-500 via-red-500 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
